...
// /wiki/(dynamic value) -- order is sooo important here
router.get('/:urlTitle', function (req, res, next) {
    ...
    Page.findOne({
            ...
            include: [ {model: User, as: 'author'} ] //this is an alternate to using `getAuthor`
        })
        .then(function (page) {
            if (page === null) {
                return next(makeError(404, 'That page was not found!'));
            } else {
                res.render('wikipage', {
                    page: page
                });
